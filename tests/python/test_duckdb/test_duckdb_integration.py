...
class TestDuckDBReadOperations:
    ...
    def test_read_iceberg_table_direct(self, duckdb_conn, pyiceberg_catalog):
        ...
        try:
            ...
            pytest.skip(f"iceberg_scan not available: {e}")
        finally:
            catalog.drop_table((*ns, "read_table"), purge=True)
            catalog.drop_namespace(ns)
    ...
    def test_read_with_projection(self, duckdb_conn, pyiceberg_catalog):
        ...
        try:
            ...
            pytest.skip("iceberg_scan not available")
        finally:
            catalog.drop_table((*ns, "projection_table"), purge=True)
            catalog.drop_namespace(ns)
    ...
    def test_read_with_filter(self, duckdb_conn, pyiceberg_catalog):
        ...
        try:
            ...
            catalog.drop_table((*ns, "filter_table"), purge=True)
            catalog.drop_namespace(ns)
...
class TestDuckDBComplexTypes:
    ...
    def test_read_decimal_types(self, duckdb_conn, pyiceberg_catalog):
        ...
        # Use PyArrow decimal type
        decimal_type = pa.decimal128(10, 2)
        df = pa.table({
            "id": [1, 2, 3],
            "amount": pa.array([Decimal("123.45"), Decimal("678.90"), Decimal("999.99")], type=decimal_type),
        })
        ...
        try:
            ...
            catalog.drop_table((*ns, "decimal_table"), purge=True)
            catalog.drop_namespace(ns)
    ...
    def test_read_timestamp_types(self, duckdb_conn, pyiceberg_catalog):
        ...
        try:
            ...
            catalog.drop_table((*ns, "timestamp_table"), purge=True)
            catalog.drop_namespace(ns)
...
class TestDuckDBTimeTravelQueries:
    ...
    def test_query_by_snapshot_id(self, duckdb_conn, pyiceberg_catalog):
        ...
        # Write first version
        df1 = pa.table({"id": [1, 2], "version": ["v1", "v1"]})
        table.append(df1)
        table.refresh()
        snapshot1_id = table.current_snapshot().snapshot_id
        
        # Write second version
        df2 = pa.table({"id": [3, 4], "version": ["v2", "v2"]})
        table.append(df2)
        table.refresh()
        ...
        try:
            ...
            catalog.drop_table((*ns, "timetravel_table"), purge=True)
            catalog.drop_namespace(ns)
...
class TestDuckDBAggregations:
    ...
    def test_aggregation_queries(self, duckdb_conn, pyiceberg_catalog):
        ...
        try:
            ...
            catalog.drop_table((*ns, "agg_table"), purge=True)
            catalog.drop_namespace(ns)
...
class TestDuckDBJoinOperations:
    ...
    def test_join_two_iceberg_tables(self, duckdb_conn, pyiceberg_catalog):
        ...
        try:
            ...
            catalog.drop_table((*ns, "users"), purge=True)
            catalog.drop_table((*ns, "orders"), purge=True)
            catalog.drop_namespace(ns)
